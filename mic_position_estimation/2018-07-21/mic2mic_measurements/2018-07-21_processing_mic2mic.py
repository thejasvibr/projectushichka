# -*- coding: utf-8 -*-
"""
Creating mic2mic matrix for 2018-07-21
======================================
...
good_mics = [0,1,2,3,4,5, 8,9,10,11,12,13]

with open('2018-07-21_goodmics.txt','w') as txtfile:
...
distmat.to_csv('mic2mic_RAW_2018-07-21.csv',na_rep='NaN')    
