# -*- coding: utf-8 -*-
"""
Aligning audio for 2018-06-21 speaker playbacks
===============================================
...
16 files for 16 channels:
    ...
    * 9-11: microphones connected to device 2
...
recording_timestamp = '1529558058' # 2 mins long, 16 audio files at 192 kHz
...
with open('../mic2mic_measurements/2018-06-21_goodmics.txt','r') as f:
