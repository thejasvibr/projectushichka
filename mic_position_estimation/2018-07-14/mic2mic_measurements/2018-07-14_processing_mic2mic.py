# -*- coding: utf-8 -*-
"""
Creating mic2mic matrix for 2018-07-14
======================================
...
good_mics = [0,1,2,3,4,5, 13,14,15,16,17]

with open('2018-07-14_goodmics.txt','w') as txtfile:
...
distmat.to_csv('mic2mic_RAW_2018-07-14.csv',na_rep='NaN')    
