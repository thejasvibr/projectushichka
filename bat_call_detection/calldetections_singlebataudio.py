# -*- coding: utf-8 -*-
"""
Applying the bat call detector on each channel individually - SINGLE
====================================================================
Refer to 'calldetections_multibataudio.py' for further context. 
...
for idx, filename in enumerate(csvfiles):
    if wavfilename[-6:] in filename:
        index = idx
        break
detection_data = pd.read_csv(csvfiles[index])
